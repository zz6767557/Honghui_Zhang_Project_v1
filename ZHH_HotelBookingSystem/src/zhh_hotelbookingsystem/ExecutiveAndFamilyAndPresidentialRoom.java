 ...
 */
public class ExecutiveAndFamilyAndPresidentialRoom extends BackgroungPaneRoomControl{
    ...
    public ExecutiveAndFamilyAndPresidentialRoom(Image baImage, String str, int startPrice, int endPrice, int validNumber) {
        super(baImage);
    ...
    protected void paintComponent(Graphics g) {
        ...
        try {
            ...
            poolImage = ImageIO.read(new File("src/zhh_hotelbookingsystem/pool.png"));
        ...
        g.setFont(titleFont);
        if (titleString.equals("Executive Room")) {
            g.drawString("Executive Room", 440, 80);
        } else if(titleString.equals("Family Room")){
            g.drawString("Family Room", 460, 80);
        } else {
            g.drawString("Persidential Suite", 440, 80);
        }
        
        g.setColor(new Color(255, 255, 255));
        g.setFont(titleFont);
        
        g.drawImage(smokingImage, this.getWidth()/2 - telephoneImage.getWidth(this)/2 - 200 - smokingImage.getWidth(this) - wifiImage.getWidth(this), 120, smokingImage.getWidth(this), smokingImage.getHeight(this), null);
        g.drawImage(wifiImage, this.getWidth()/2 - telephoneImage.getWidth(this)/2 - 100 - wifiImage.getWidth(this), 120, wifiImage.getWidth(this), wifiImage.getHeight(this), null);
        g.drawImage(telephoneImage, this.getWidth()/2 - telephoneImage.getWidth(this)/2, 120, telephoneImage.getWidth(this), telephoneImage.getHeight(this), null);
        g.drawImage(hairDyerImage, this.getWidth()/2 + telephoneImage.getWidth(this)/2 + 100, 120, hairDyerImage.getWidth(this), hairDyerImage.getHeight(this), null);
        g.drawImage(poolImage, this.getWidth()/2 + telephoneImage.getWidth(this)/2 + 200 + hairDyerImage.getWidth(this), 120, poolImage.getWidth(this), poolImage.getHeight(this), null);
